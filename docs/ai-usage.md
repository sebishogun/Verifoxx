...
AI output was treated as an untrusted draft and checked against the assignment,
the approved design, compiler and evaluator invariants, automated tests, race
